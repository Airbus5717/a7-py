...
def create_program(declarations: List[ASTNode] = None, span: SourceSpan = None) -> ASTNode:
...
def create_literal(kind: LiteralKind, value: Any, raw_text: str, span: SourceSpan = None) -> ASTNode:
...
def create_binary_expr(left: ASTNode, op: BinaryOp, right: ASTNode, span: SourceSpan = None) -> ASTNode:
...
def create_function_decl(name: str, parameters: List[ASTNode] = None, return_type: ASTNode = None, 
                        body: ASTNode = None, is_public: bool = False, span: SourceSpan = None) -> ASTNode:
...
def create_parameter(name: str, param_type: ASTNode, is_variadic: bool = False, span: SourceSpan = None) -> ASTNode:
...
def create_call_expr(function: ASTNode, arguments: List[ASTNode] = None, span: SourceSpan = None) -> ASTNode:
...
def create_assignment_stmt(target: ASTNode, op: AssignOp, value: ASTNode, span: SourceSpan = None) -> ASTNode:
...
def create_var_decl(name: str, value: ASTNode, explicit_type: ASTNode = None, 
                   is_public: bool = False, span: SourceSpan = None) -> ASTNode:
...
def create_const_decl(name: str, value: ASTNode, explicit_type: ASTNode = None, 
                     is_public: bool = False, span: SourceSpan = None) -> ASTNode:
...
def token_to_unary_op(token_type: TokenType) -> Optional[UnaryOp]:
    ...
    mapping = {
        ...
        TokenType.MULTIPLY: UnaryOp.DEREF,    # * as dereference
    }
    return mapping.get(token_type)
